...
echo "当前模式$mode 温控档位$thermal_scene 充电场景$thermal_charge 游戏场景$thermal_app 充电$dumpsys_charging 手动旁路$bypass_supply_mode 电量$battery_level 电量旁路$bypass_supply_level 温度$battery_temp 温度旁路$bypass_supply_temp 游戏旁路$bypass_supply_app"
echo --------- 系统温控 ----------
