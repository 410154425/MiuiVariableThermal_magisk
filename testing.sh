...
echo "模式$mode 档位$thermal_scene 充电场景$thermal_charge 游戏场景$thermal_app 刷新率$fps 充电状态$dumpsys_charging 旁辅$current_max 电流$current_now 旁停$stop_level 手动旁路$bypass_supply_mode 电量$battery_level 电量旁路$bypass_supply_level 温度$battery_temp 温度旁路$bypass_supply_temp 游戏旁路$bypass_supply_app"
echo --------- 电流节点 ----------
